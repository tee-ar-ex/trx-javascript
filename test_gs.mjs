...
async function runTests() {
    ...
    assert.deepStrictEqual(Array.from(trk.offsetPt0), Array.from(tck.offsetPt0), "TRK vs TCK offsets");
    assert.deepStrictEqual(Array.from(trk.offsetPt0), Array.from(vtk.offsetPt0), "TRK vs VTK offsets");
    assert.deepStrictEqual(Array.from(trk.offsetPt0), Array.from(trx.offsetPt0), "TRK vs TRX offsets");
